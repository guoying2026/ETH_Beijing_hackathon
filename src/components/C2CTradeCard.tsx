...
const T = {
  zh: {
    ...
    retryBtn: '重新尝试生成证明',
    backOrder: '返回转账订单页',
    errNoExtension: '未检测到 zkTLS 浏览器扩展插件！请先在页面顶部下载并安装 Chrome 扩展程序，以便生成转账的 zkTLS 零知识证明来释放托管资金。您也可以在此处 [点击下载扩展包 (ZIP)](/zkTLS-extension.zip)。',
  ...
  en: {
    ...
    errNoExtension: 'zkTLS browser extension not detected! Please download and install the Chrome extension from the top of the page, or click here to [download extension zip](/zkTLS-extension.zip) directly.',
